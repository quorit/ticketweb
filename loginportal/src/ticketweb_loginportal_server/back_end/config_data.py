...
_etc_path = os.getenv("CONFIG_DIR", "/etc/ticketweb/loginportal")
...
def _get_config_data_all():
    ldap_file = os.path.join(_etc_path,"server-config.json5")
...
def _init_rsa_key_data():
    key_file = os.path.join(_etc_path,"secret.pem")
